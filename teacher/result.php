    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <a href="result.php?action=add-new" class="btn btn-primary btn-sm">Add New</a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="result.php?id=<?php echo $info['id'] ?>"  class="btn btn-xs btn-danger"><i class="fa fa-trash fw"></i> Delete</a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
