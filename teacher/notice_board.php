    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <a href="notice_board.php?action=add-new" class="btn btn-primary btn-sm">Add New</a>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <?php if ($_GET['action'] == 'add-new') { ?>
                        ...
                        <label for="name">Name</label>
                            <input type="text" required name="name" placeholder="Enter File Name" class="form-control">
                            <br>
                        ...
                        <div class="table-responsive bg-white">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $count = 1;
                                    $query2 = mysqli_query($db, "SELECT * FROM files WHERE type='notice'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td>
                                                <a href="notice_board.php?file=<?php echo $info['file'] ?>"  class="btn btn-xs btn-info"><i class=" fa fa-solid fa-download"></i> Download</a>
                                                
                                                <a href="notice_board.php?id=<?php echo $info['id'] ?>"  class="btn btn-xs btn-danger"><i class="fa fa-trash fw"></i> Delete</a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
