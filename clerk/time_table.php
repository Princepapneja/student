    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <a href="time_table.php?action=add-new" class="btn btn-primary btn-sm">Add New</a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <form action="time_table.php" method="post" enctype="multipart/form-data">
                                ...
                                <textarea name="details" required placeholder="Details" class="form-control"></textarea>
                                <br>
                        ...
                        <div class="table-responsive bg-white">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $count = 1;
                                    $query2 = mysqli_query($db, "SELECT * FROM files WHERE type='timetable'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td>
                                                <a href="time_table.php?file=<?php echo $info['file'] ?>" class="btn btn-xs btn-info"><i class=" fa fa-solid fa-download"></i> Download</a>

                                                <a href="time_table.php?id=<?php echo $info['id'] ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash fw"></i> Delete</a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
