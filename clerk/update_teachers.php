...
if (isset($_POST['update_details'])) {
    ...
    if ($query) {
        ...
        $_SESSION['message'] = 'Teacher Details is Updated Succesfuly';
    ...
    <div class="card-body" id="form-container">
        <form action="#" method="post" enctype="multipart/form-data">
            <fieldset class="border border-secondary p-3 form-group">
                ...
                <legend class="d-inline w-auto h5">Teacher Image</legend>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <img height="100px" width="100px" src="../dist/uploads/<?php echo "{$info['image']}"; ?>" alt="Teacher Image">
                        </div>
                    </div>
                </div>
            </fieldset>
            <fieldset class="border border-secondary p-3 form-group">
                ...
                <legend class="d-inline w-auto h5">Teacher Information</legend>
